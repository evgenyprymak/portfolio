    ...
    <div className="container-fluid px-0">
      ...
      <div className='container-xxl'>
        <div className='row row-gap-10'>
          <Metric1 className='col-12 col-md-4 card-gap-10' above='About' mainmetric='750' color='var(--txt-light-1)' below='Events used Quasar to sell their tickets' />
          <Metric1 className='col-12 col-md-4 card-gap-10' above='More than' mainmetric='5.7M' color='var(--txt-light-1)' below='Tickets sold per year' />
          <Metric1 className='col-12 col-md-4 card-gap-10' above='Up to' mainmetric='73%' color='var(--txt-light-1)' below='Conversion rate' />
        </div>
      </div>
