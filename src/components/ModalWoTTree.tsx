    ...
    <div className="modal-overlay" onClick={(e) => { e.stopPropagation(); onClose(); }}>
      <div className="dialog" onClick={(e) => e.stopPropagation()}>
        <div className="dialog-content" style={{ backgroundColor: 'red !important' }} >
          ...
          <p className='mt-40'>
            Tech Tree 2.0 is a complete overhaul of the World of Tanks tech tree, designed to improve navigation, clarity, and user experience. The redesign introduces a more intuitive layout, enhanced visual hierarchy, and streamlined access to vehicle information. Key features include collapsible branches for easier browsing, improved filtering options, and detailed vehicle stats presented in a user-friendly format.
          </p>
          <p className='pb-20'>
