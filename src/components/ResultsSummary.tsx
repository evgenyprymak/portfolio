...
const ResultsSummary: React.FC = () => {
    ...
    return (
        <div className="f-width px-0 py-0">
            <motion.div
                    ...
                    <div className='row'>
                        <div className='col-lg-4 col-md-12 col-sm-12'>
                            <div className='d-flex flex-column flex-lg-column flex-md-row flex-sm-column flex-sm-wrap'>
                                <Metric4 className='col-lg-12 col-md-4 col-sm-12 flex-sm-grow-1' above='Role' mainMetric='Lead Product Designer' color={activeTextColor} />
                                <Metric4 className='col-lg-12 col-md-4 col-sm-12 flex-sm-grow-1' above='Timeline' mainMetric='2020–2024' color={activeTextColor} />
                                <Metric4 className='col-lg-12 col-md-4 col-sm-12 flex-sm-grow-1' above='Team size' mainMetric='3-10' color={activeTextColor} />
                            </div>
